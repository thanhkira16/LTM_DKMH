    ...
    private static class ClientHandler extends Thread {
        ...
        private String handleLogin(String studentId, String password) {
            try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
                 PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM students WHERE student_id = ? AND password = ?")) {
        ...
        private String getFullName(String studentId) {
            try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
                 PreparedStatement preparedStatement = connection.prepareStatement("SELECT student_name FROM students WHERE student_id = ?")) {
        ...
        private String getClassName(String studentId) {
            try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
                 PreparedStatement preparedStatement = connection.prepareStatement("SELECT class_name FROM students WHERE student_id = ?")) {
        ...
        private List<Student> getStudentInfo() {
            ...
            try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
                 PreparedStatement preparedStatement = connection.prepareStatement("SELECT student_id, student_name, password, birth_date, class_name, major FROM students");
                 ResultSet resultSet = preparedStatement.executeQuery()) {
